...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //<editor-fold desc="Location Permissions Disabled...">
...
//            int modeType = AppCompatDelegate.getDefaultNightMode();
            ...
            if (Singleton.getInstance().getDarkMode()) {
                // Set Default Day Mode
                AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
            } else {
                // Set Default Night Mode
            ...
            Singleton.getInstance().toggleDarkMode();
            reCreate();
        }
    ...
    //<editor-fold desc="Request permission result">
//    @Override
